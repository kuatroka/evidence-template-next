SELECT 
    ...
    COUNT(DISTINCT cik) AS num_ciks_per_quarter,
    COUNT(DISTINCT cusip) AS num_cusip_per_quarter,      
    SUM(value)::bigint AS total_value_per_quarter,     
    (SELECT COUNT(DISTINCT cik) FROM main.main WHERE accession_number != 'SYNTHETIC-CLOSE')::integer AS total_ciks,
